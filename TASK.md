...
2. **더미 데이터(DataLoader) 확정** → 프론트가 실제 데모 페르소나 1~5 를 화면에서 재현하려면 어떤 고객/전화번호/SKU 로 테스트해야 하는지 알아야 한다. (연락처: 테스트 고객 "김세계" 010-1234-5678, 시작 SKU: id=1 "M Diamond 비세토스 레더 믹스 · 꼬냑")
